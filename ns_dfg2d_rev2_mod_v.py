...
parser.add_argument('--output', type=str, default='/home/vrodrigues/supg_stabilization/results_Re100_dfg2d_pspg_v')
...
# Inlet tempo-dependente: amplitude 1.5*sin(pi*t/8)
# Expression com parâmetro 't' que será atualizado a cada passo
uin = Expression((
    '4.0*1.5*sin(pi*t/8.0)*x[1]*(H - x[1])/(H*H)',
    '0.0'
), t=0.0, H=args.H, pi= np.pi ,degree=2)
...
while t < Tfinal - 1e-12:
    ...
    # Atualizar valor do parâmetro 't' no inlet
    uin.t = t
